...
public class GoodsAdapter extends BaseAdapter{
    ...
    private SupermarketActivity supermarketfragment;
    DecimalFormat df=new DecimalFormat("0.##");
    private List<GouWuChe> mList;
    private GouWuChe gouwuche;

    public GoodsAdapter(Context context, SupermarketActivity supermarketfragment, List<ShangPinList.Result.Products> list2, CatograyAdapter catograyAdapter) {
