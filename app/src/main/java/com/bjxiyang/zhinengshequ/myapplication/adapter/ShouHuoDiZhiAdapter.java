...
import com.bjxiyang.zhinengshequ.myapplication.activity.AddShouHuoDiZhiActivity;
...
//                    unitId
        ...
        viewHolder.rl_item_bianji_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("address",mList.get(position).getCommunityName()
                +mList.get(position).getNperName()+mList.get(position).getUnitName()
                +mList.get(position).getFloorName()+mList.get(position).getDoorName());
