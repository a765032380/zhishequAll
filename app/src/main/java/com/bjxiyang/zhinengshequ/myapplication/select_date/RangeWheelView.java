...
package com.bjxiyang.zhinengshequ.myapplication.select_date;
 ...
 */
public class RangeWheelView extends View {
	...
	// Listeners
	private List<OnWheelRangeChangedListener> changingListeners = new LinkedList<OnWheelRangeChangedListener>();
	private List<OnWheelRangeScrollListener> scrollingListeners = new LinkedList<OnWheelRangeScrollListener>();

	/**
	 * Constructor
	 */
	public RangeWheelView(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * Constructor
	 */
	public RangeWheelView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initData(context);
	}
	 ...
	 * Constructor
	 */
	public RangeWheelView(Context context) {
		super(context);
		initData(context);
	}
	 ...
	 *            the listener
	 */
	public void addChangingListener(OnWheelRangeChangedListener listener) {
	...
	protected void notifyChangingListeners(int oldValue, int newValue) {
		for (OnWheelRangeChangedListener listener : changingListeners) {
	 ...
	 *            the listener
	 */
	public void addScrollingListener(OnWheelRangeScrollListener listener) {
	...
	protected void notifyScrollingListenersAboutStart() {
		for (OnWheelRangeScrollListener listener : scrollingListeners) {
...
//		setBackgroundResource(R.drawable.wheel_bg);
	...
	private void drawCenterRect(Canvas canvas) {
		...
		canvas.drawLine(0, center
				+ offset,getWidth(),center
				+ offset,paint);
