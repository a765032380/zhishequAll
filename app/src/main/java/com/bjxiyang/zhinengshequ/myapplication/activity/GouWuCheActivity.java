...
import com.bjxiyang.zhinengshequ.myapplication.adapter.ShopcatAdapter;
...
public class GouWuCheActivity extends MySwipeBackActivity implements View.OnClickListener, ShopcatAdapter.CheckInterface, ShopcatAdapter.ModifyCountInterface, ShopcatAdapter.GroupEditorListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT, 20);
        params.gravity = Gravity.TOP;
        statusBarView.setLayoutParams(params);
        statusBarView.setBackgroundColor(0x4183FF);
