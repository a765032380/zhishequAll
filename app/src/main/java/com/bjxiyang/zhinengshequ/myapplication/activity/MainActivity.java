...
public class MainActivity extends BaseActivity implements View.OnClickListener{
    ...
    public RelativeLayout mPondLayout;
    @BindView(R.id.ll_menjin)
    public LinearLayout ll_menjin;
    @BindView(R.id.message_layout_view)
    public RelativeLayout mMessageLayout;
    @BindView(R.id.mine_layout_view)
    public RelativeLayout mMyLayou;

    @BindView(R.id.home_image_view)
    public TextView mHomeView;
    @BindView(R.id.fish_image_view)
    public TextView mPondView;
