...
public class EaseContactAdapter extends ArrayAdapter<EaseUser> implements SectionIndexer{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (userList.get(position).getBeizhu()!=null&&!userList.get(position).getBeizhu().equals("")){
            EaseUserUtils.setUserNick(userList.get(position).getBeizhu(), holder.nameView);
        }else {
